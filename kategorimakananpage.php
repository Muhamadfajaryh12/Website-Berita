...
<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        <div class="container-fluid">
          ...
          <li><a class="dropdown-item" href="kategoripolitikpage.php">Politik</a></li>
            <li><a class="dropdown-item fw-bold" href="kategorimakananpage.php">Makanan</a></li>
...
<?php  
$result_db = mysqli_query($koneksi,"SELECT COUNT(*) as jumlah FROM berita WHERE id_kategori ='4'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link bg-dark text-white' href='kategorimakananpage.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
